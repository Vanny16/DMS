                    ...
                    <div class="post-content post-single">
                        ...
                        <div class="post-body">
                            ...
                            <div class="entry-content">
                                <div id="summernote">{!! $news_article->news_content !!}</div>
                            </div>
                            <div class="post-footer">
                                <a class="btn btn-primary" href="{{ action('NewsController@home') }}"><span class="fa fa-arrow-left"></span> Back to News</a>
                            </div>
                        </div>
                    </div>
