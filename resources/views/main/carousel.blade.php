    ...
    <div class="banner-carousel-item" style="background-image:url({{ asset('images/slider/bg1.jpg') }})">
        <div class="slider-content">
            <div class="container h-100">
                <div class="row align-items-center h-100">
                    <div class="col-md-12 text-center">
                        <h2 class="slide-sub-title" data-animation-in="slideInLeft">PIEP</h2>
                        <h3 class="slide-title" data-animation-in="slideInRight">Serving Filipino Planners</h3>
                        <h3 class="slide-title" data-animation-in="slideInLeft">creating better communitiesT</h3>
                        <p data-animation-in="slideInRight" data-duration-in="1.2">
                            {{-- <a class="slider btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#reportInnovationModal" target="_BLANK" rel="noopener noreferrer">
                                Submit Innovation
                            </a>
                            <a href="#" class="slider btn btn-primary border">View Innovations</a> --}}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container h-100">
                <div class="row align-items-center h-100">
                    <div class="col-md-12">
                        ...
                        {{-- <h3 class="slide-sub-title" data-animation-in="fadeIn">SALIKLAKBAY</h3>
                        <h3 class="slide-title" data-animation-in="slideInLeft">-a combination of the words ‘Saliksik’ (to explore/ research) and ‘Lakbay’ (to journey/go in an adventure), aims to equip participants with background knowledge, skills and practical experience in conducting solutions mapping in grassroots communities.</h3> --}}
                        {{-- <p data-animation-in="slideInRight">
                            <a href="#" class="slider btn btn-primary border">View Innovations</a>
                        </p> --}}
                    </div>
    ...
    <div class="banner-carousel-item" style="background-image:url({{ asset('images/slider/bg3.jpg') }})">
        <div class="slider-content text-right">
            <div class="container h-100">
                <div class="row align-items-center h-100">
                    <div class="col-md-12">
                        <h2 class="slide-sub-title" data-animation-in="slideInDown">PIEP</h2>
                        <h3 class="slide-title" data-animation-in="fadeIn"></h3>
                        <p class="slider-description lead" data-animation-in="slideInRight">Lend a hand to save communities</p>
                        <div data-animation-in="slideInLeft">
                            {{-- <a class="slider btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#reportInnovationModal" target="_BLANK" rel="noopener noreferrer">
                                Submit Innovation
                            </a>
                            <a href="#" class="slider btn btn-primary border" aria-label="legion-of-topnotchers">View Innovations</a> --}}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-8 text-center text-md-left">
                    <div class="call-to-action-text">
                        <h3 class="action-title">See the latest news and announcements</h3>
                    </div>
                </div>
                <div class="col-md-4 text-center text-md-right mt-3 mt-md-0">
                    <div class="call-to-action-btn">
                        <a class="btn btn-dark" target="_blank" href="#"><span class="fa fa-newspaper"></span> News</a>
                    </div>
                </div>
            </div>
        </div>
